...
What made this so confusing is that Keybase had nothing to do with what I was actually trying to do. It wasn't installed via Flatpak, I wasn't using it, and the errors I was seeing (Flatpak bwrap errors, failed pidfiles) pointed nowhere near it. The hang was also intermittent — most reboots cleared the stale mount automatically, masking the real cause for months.